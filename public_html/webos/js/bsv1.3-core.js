	...
	return me = {
		...
		bindStyle:function(){
			$(".sonfile").mouseenter(function(){
				$(this).css({"background-image": "url(/webos/images/bg_task_group_t_over.png)"});
			});
			$(".sonfile").mouseleave(function(){
				$(this).css({"background-image": "url(/webos/images/bg_task_group_t.png)"});
			});
		},
		bindEvent:function(id){
			$(".sonMenuList").bind("mouseenter",function(){
				$(this).css({"background-image": "url(/webos/images/appbutton_mouseover_bg3.png)"});
			});
			...
			if(taskItem.length==1){
				...
				var sonfile = "<a id=\"sonfile_a"+id+"\" href=\"#\">"+
					"<div id=\"sonfile_"+id+"\" class=\"sonfile\">"+
						"<div class=\"min_icon_sonfolder\">"+
							"<img width=\"32\" height=\"32\" border=\"0\" src=\"/webos/icon/min/"+icon+"\" />"+
						"</div>"+
				...
				if(jsonSonMenu.length>0){
					...
					var _box ="<div id=\"sonMenu_box"+id+"\" class=\"sonMenuListBox\"><div class=\"sonMenu_line\">"+
						"<span class=\"sonMenu_font\">文件夹</span></div>"+sonlist+"</div>";
					*/
					/*2014年7月22日添加*/
					var _box='<div class="quick_view_container" id="quickViewContainer_1000" customacceptdrop="1" style="position: absolute;display: none; z-index: 300002; width: 340px; top: 334px; left: 213px;"><div class="perfect_nine_box" id="perfect_nine_box_1000" style="height: 120px;"><div id="perfect_nine_top_1000" class="perfect_nine_top" style="padding-left: 15px; padding-right: 15px;"><div id="perfect_nine_t_m_1000" class="perfect_nine_t_m" style="height: 10px;"></div></div><span id="perfect_nine_t_l_1000" class="perfect_nine_t_l" style="width: 15px; height: 10px; margin-top: -10px;"></span><span id="perfect_nine_t_r_1000" class="perfect_nine_t_r" style="width: 15px; height: 10px; margin-top: -10px;"></span><div id="perfect_nine_middle_1000" class="perfect_nine_middle"><span id="perfect_nine_m_l_1000" class="perfect_nine_m_l" style="width: 15px;"><div class="perfect_nine_m_l_t" style="height: 60px;"></div><div class="perfect_nine_m_l_m" style="top: 60px; height: 20px; display: block;"></div><div class="perfect_nine_m_l_b" style="top: 80px; height: 20px;"></div></span><span id="perfect_nine_m_r_1000" class="perfect_nine_m_r" style="width: 15px;"><div class="perfect_nine_m_r_t" style="height: 50px;"></div><div class="perfect_nine_m_r_m" style="display: none;"></div><div class="perfect_nine_m_r_b" style="height: 50px; top: 50px;"></div></span><div id="perfect_nine_context_1000" class="perfect_nine_context" style="height: 100px; margin-left: 15px; margin-right: 15px;"><div class="quick_view_container_control"><a href="###" class="quick_view_container_open" id="quick_view_container_open_1000">文件夹</a><a></a></div><div class="quick_view_container_list" id="quick_view_container_list_1000"><div class="quick_view_container_list_in" id="quick_view_container_list_in_1000" style="height: 70px; overflow: hidden;">{sonlist}</div><div class="scrollBar" _olddisplay="" style="margin-top: 0px; height: 0px; display: none;"></div><div class="scrollBar_bgc" _olddisplay="block" style="display: none;"></div></div></div></div><div id="perfect_nine_b_m_1000" class="perfect_nine_b_m" style="padding-left: 15px; padding-right: 15px; height: 10px;"><div id="perfect_nine_b_m_m_1000" class="perfect_nine_b_m_m" style="height: 10px;"></div></div><span id="perfect_nine_b_l_1000" class="perfect_nine_b_l" style="width: 15px; height: 10px; margin-top: -10px;"></span><span id="perfect_nine_b_r_1000" class="perfect_nine_b_r" style="width: 15px; height: 10px; margin-top: -10px;"></span></div></div>';
					for(var i=0;i<jsonSonMenu.length;i++ ){
                        sonlist+='<div appid="'+jsonSonMenu[i].appid+'" fileid="'+jsonSonMenu[i].appid+'" type="app" id="" url="'+jsonSonMenu[i].url+'" uid="" class="appButton sonMenuList" title="'+jsonSonMenu[i].name+'">'+
                           '<div class="appButton_appIcon " id="" style="">'+
                                '<img id="" class="appButton_appIconImg" src="/webos/icon/'+jsonSonMenu[i].icon+'" alt="'+jsonSonMenu[i].name+'">'+
                            '</div>'+
                            '<div class="appButton_appName">'+
                                '<div id="" class="appButton_appName_inner">'+
                                    jsonSonMenu[i].name+
                                '</div>'+
                                '<div class="appButton_appName_inner_right">'+
                                '</div>'+
                            '</div>'+
                            '<div class="appButton_delete" id="" title="卸载应用">'+
                            '</div>'+
                       '</div>';
					}
					_box = _box.replace("{sonlist}", sonlist);
					$("#quickViewContainer_1000").remove();
					Desktop.addPanel(_box);
					me.closeMinTask(id);
					
					/*用于打开文件夹*/
					var folderpos = $(".appButton[appid="+id+"]").offset();
					var folderposLeft = folderpos.left + 85 + "px";
					var folderposTop = folderpos.top - 40 +"px";
					$("#quickViewContainer_1000").css({"left":folderposLeft,"top":folderposTop,"display":"block"});
					/*2014年7月22日添加*/
					/*
					art.dialog({
						"id":id,
					...
					*/
					...
					/*2014年7月19日 添加 由于设置窗口大小*/
						var xwidth = 980+"px";
						var xheight = height;
						try{
							xwidth = url.match(/\[(\d+,\d+)\]/)[1].split(",")[0]+"px";
							xheight = url.match(/\[(\d+,\d+)\]/)[1].split(",")[1]+"px";
							url = url.replace(/\[(\d+,\d+)\]/,'');
						}catch(err){
...
appIcon_t1 = appIcon_t0.extend({		
	...
	create:function(fid){
		...
		appIcon.append($("<img>",{
			alt:this.app.name ,
			src:'/webos/icon/'+this.app.icon,//图片路径-------------------------------------------------------------------------------------------
...
mouseStyle = function(){//箭头样式
	$("#arrows_l").mouseenter(function (){
		if(thisPage==1){
			...
			$("#arrows_l img").attr("src","/webos/images/arrows_l_2.png");
		}
	});
	$("#arrows_r").mouseenter(function (){
		if(thisPage==DATA.menu.length){
			...
			$("#arrows_r img").attr("src","/webos/images/arrows_r_2.png");
		}
	});
		...
		bindEvent:function(){
			...
			function down(e){
				...
				if(value==2||value==3){
					...
					if($("#quickViewContainer_1000").css('display')=="block"){
						$("#quickViewContainer_1000").fadeOut();
					}
					$("#quickViewContainer_1000").css("display");
					if(window.zbx < (me.box.width()/2)){
						window.biaoshi='left';
					}else{
						window.biaoshi='right';
					}
				}
			}
			...
			function up(e){
				...
				if(value==2||value==3){
					...
					if(window.zbx < (me.box.width()/2)){
						if(window.biaoshi=='right'){
							/*$("#arrows_r").click();*/
						}else{
							window.biaoshi='';
						}
					}else{
						if(window.biaoshi=='left'){
							/*$("#arrows_l").click();*/
						}else{
							window.biaoshi='';
						}
			...
			me.box.bind('mousedown',down).bind('mouseup',up).bind('mousemove',move);
		}
	};
}();
/*鼠标左右移动桌面*/
...
AppRight=function(me){
	return me={	
		...
		create:function(){
			me.box=$(".appButton[type=app]");
			me.dirbox=$(".appButton[type=dir]");
			me.addbox=$(".appButton[type=add]");
		},
		addPanel:function(panel){
		...
		setMenu:function(){
			var AppMenuData = me.AppMenuData();
			me.box.smartMenu(AppMenuData, {
				name: "app"    
			});
			var DirMenuData = me.DirMenuData();
			me.dirbox.smartMenu(DirMenuData, {
				name: "folder"    
			});
			var AddMenuData = me.AddMenuData();
			me.addbox.smartMenu(AddMenuData, {
				name: "addbutton"    
			});
		}
	};
...
$(function(){
	$("#smartMenu_app li.smart_menu_li:contains('修改应用')").change(function(){
	  $(this).addClass("desktopSmallIcon");
	});
});

/*用于添加删除桌面应用*/
AppAddDelete=function(me){
	return me={	
		init:function(ops){
			me.create(ops);
			/*me.setMenu();*///绑定右键
